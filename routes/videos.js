  ...
  fs.rename(req.file.path, targetPath, async (err) => {
    ...
    try {
      const result = await db.query(
        "INSERT INTO videos (title, description, category_id, filename, tags, uploaded_by) VALUES ($1, $2, $3, $4, $5, $6) RETURNING *",
        [title, description, category, req.file.originalname, tags, req.user?.id || null]
      );
